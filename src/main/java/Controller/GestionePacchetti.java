...
public class GestionePacchetti {
	...
	public void visualizzaServizi(int idCity,int i) throws SQLException {
		...
		System.out.println();
		System.out.println("I seguenti servizi sono i servizi di ristorazione disponibili nella citt� associata al pacchetto che hai scelto.");
		System.out.println();
		int l = 0;
		for(int k=0;k<listaSR.size();k++) {
		   ...
		   System.out.println(listaSR.get(k).toString());
			...
			System.out.println("Questi sono i servizi di visite museali nella citt� associata al pacchetto che hai scelto.");
			 System.out.println();
